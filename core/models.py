...
class Picture(models.Model):
    ...
    like_account = models.ManyToManyField(Account, blank=True, null=True, related_name="picture_like_account")
...
class Comment(models.Model):
    ...
    account = models.ForeignKey(Account, blank=True, null=True)
    like_account = models.ManyToManyField(Account, blank=True, null=True, related_name="comment_like_account")
